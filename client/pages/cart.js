document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderCartItem(item, index) {
        ...
        itemRow.innerHTML = `
            ...
            <td><button class="delete-button" data-index="${index}"><img src="" alt="Eliminar" style="width: 35px; height: 35px;">
    ...
    function resetInputFields() {
        alert('Compra generada con éxito! Recibirá un mail a la brevedad')
